...
alias qwen-coder-think='/opt/homebrew/bin/llama-cli -m /Users/tzh/models/qwen-3_6-27B/Qwen3.6-27B-Q6_K.gguf -t 0.6 -c 16384 -ngl all --top-p 0.95 --top-k 20 --spec-type draft-mtp --spec-draft-n-max 3 --spec-draft-n-min 0.75 -sys "You are a coding assistant."'
